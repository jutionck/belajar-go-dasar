...
var minimalNama int = 3
var maksimalNama int = 20
var minimalUmur int = 17
var maksimalJurusan int = 20
...
func tambahMahasiswa() {
	...
	isValidName := cekValidasiNama(namaMhs, minimalNama, maksimalNama)
	isValidUmur := cekValidasiUmur(umurMhs, minimalNama)
	isValidJurusan := cekValidasiJurusan(jurusanMhs, maksimalNama)
	if isValidName && isValidUmur && isValidJurusan {
...
// validasi nama min 3 max 20
func cekValidasiNama(nama string, minimal, maksimal int) bool {
	if len(nama) <= minimal && len(nama) >= maksimal {
		return true
	}
	return false
}
func cekValidasiUmur(umur, minimal int) bool {
	if umur < minimal {
		return true
	}
	return false
}
func cekValidasiJurusan(jurusanMhs string, maksimal int) bool {
	if len(jurusanMhs) < maksimal {
		return true
	}
	return false
}
